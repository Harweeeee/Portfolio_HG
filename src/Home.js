    ...
    return (
        <div className="Home">
            <header>
                <Nav />
                <div className="hero">
                    <h1 className="secondaryFont fontColour">
                        Harleigh Gallant
                    </h1>
            ...
            <main>
                <Container fluid className="profileContent">
                    <Row>
                        <Col md>
                            {' '}
                            <img
                                ...
                                alt="Profile of Harleigh"
                            />
                        </Col>
                        <Col className="profileBlurb" md>
                            <p className="secondaryFont profileGreeting">
                                Hello 👋
                            </p>
                            ...
                            <div className="navBtnContainer">
                                <Link
                                    to="/projects"
                                    className="navButton secondaryColour"
                                >
                                    Projects
                                </Link>
                                <Link
            ...
            <footer>
                <span className="language dropShadow">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 384 512"
                        className="languageIconHome"
                    >
                        <path
                            fill="#212121"
